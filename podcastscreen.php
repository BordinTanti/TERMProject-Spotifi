						...
						<span class="oi oi-menu"></span> Menu
								...
								<div class="collapse navbar-collapse" id="ftco-nav">
									<ul class="navbar-nav ml-auto">		
										...
										<li class="nav-item active"><a href="podcastscreen.php" class="nav-link" style="margin-top: 1px;">Podcast</a></li>
    ...
    <section class="ftco-section contact-section" style="background-color: #07506e;">
			...
			<div class="row" style="margin: 20px 30px 20px 30px;">
			    ...
			    <a href="#" class="hvr-bounce-in">
					<img style="hight: 150px;width: 150px;margin-left: 30px;" src="images/myfavmurder.jpg"/>
				</a>
				<h2 style="margin-top: 20px;margin-left: 29px;font-size: 16px;">My Favorite Murder</h2>
				</div>
				
				<!-- -->
				<div class="column">	
				<a href="#" class="hvr-bounce-in">
					<img style="hight: 150px;width: 150px;margin-left: 30px;" src="images/thedaily.jpg"/>
				</a>
				<h2 style="margin-top: 20px;margin-left: 68px;font-size: 16px;">The Daily</h2>
				</div>
				
				<!-- -->
				<div class="column">	
				<a href="#" class="hvr-bounce-in">
					<img style="hight: 150px;width: 150px;margin-left: 30px;" src="images/thisamericanlife.jpg"/>
				</a>
				<h2 style="margin-top: 20px;margin-left: 34px;font-size: 16px;">This American life</h2>
				</div>
				
				<!-- -->
				<div class="column">	
				<a href="#" class="hvr-bounce-in">
					<img style="hight: 150px;width: 150px;margin-left: 30px;" src="images/stuffyoushouldknow.jpg"/>
				</a>
				<h2 style="margin-top: 20px;margin-left: 20px;font-size: 16px;">Stuff You Should Know</h2>
				</div>
				<!-- -->
				<div class="column">	
				<a href="#" class="hvr-bounce-in">
					<img style="hight: 150px;width: 150px;margin-left: 30px;" src="images/thejoe.jpg"/>
				</a>
				<h2 style="margin-top: 20px;margin-left: 4px;font-size: 16px;">The Joe Rogan Experience</h2>
				</div>
			</div>
			<div style="text-align: right;margin-top: 45px;">
				<form action="" method="post">					        
					<input type="text" name="textSearch" placeholder="Insert podcast name or creator name" style="width: 350px;text-align: center;">
	                <input type="submit" style="margin-right: 3px;" value="Search"><input type="submit" value="All Podcast"><br>					
				</form>
				<form action="" method="get">
					<button style="margin: 10px 1px" type="submit" name="favpodcast" value="fav_podcast">My Favorite Podcast</button>
				</form>			
			</div>	
			<div style="padding-top: 50px;">
			    <?php include('selectPodcast.php'); ?> 
				<?php include('addfavpodcast.php'); ?> 
