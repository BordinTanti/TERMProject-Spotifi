...
<html lang="en">
  <head>
    <title>Spotifi - subscription</title>
    <meta charset="utf-8">
	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item active"><a href="subscription.php" class="nav-link">Subscription Plan</a></li>
        ...
        <div class="row no-gutters slider-text js-fullheight align-items-start justify-content-start" data-scrollax-parent="true" style="height: 937px;padding-top: 180px;padding-bottom: 180px;text-align: center;">
		  ...
		  <div class="contact-form">
			 ...
			 <div Style="text-align: left;"><br>
			  <p style="font-size: 150%">1. Free</p>
			  <p style="font-size: 150%"> &nbsp;&nbsp; - Every account that sign up will got this type of subscription, but will limit your use and how many time you can skip music.</p><br>
			  <p style="font-size: 150%">2. Premium</p>
			  <p style="font-size: 150%"> &nbsp;&nbsp; - Premium subscription will give you higher quality of music, unlimit skip and no ad for 1 user.</p><br>
			  <p style="font-size: 150%">3. Family Premium</p>
